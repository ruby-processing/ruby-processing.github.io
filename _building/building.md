...
You will need to install jdk8, maven (apache-maven-3.5), jruby-9.1.12.0+, have access to processing-3.3.5 jars.  Note we prefer a local install of [minitest][minitest] for testing.
