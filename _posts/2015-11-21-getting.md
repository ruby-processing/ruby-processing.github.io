...
Setting JRubyArt for the first time, can seem a bit involved to set up (especially if you are addicted to rvm or rbenv). The JRubyArt gem relies on JRuby-9.0.4.0+, Processing-3.0.1, and a handful of other dependencies. Here's how to get them all installed and working on the Mac.
